...
import os
error = 0
mainText= """Выберете желаемый результат из предложенных:
    ...
    8. Сильнейшее отравление и летального исход
"""
...
while True:
    ...
    if pointGender == 1:
        ...
        if error == 3:
            ...
            print("Мы поняли! Вы являетесь Сверхчеловеком, поэтому пол для вас не существенен\n")
            gender = 0.65
            break
